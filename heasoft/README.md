This directory contains utilities and instructions for Heasoft and XSPEC, including:
...
5. heasoft_module.lua and caldb_module.lua - newer versions of the Heasoft and CALDB modules written Lua for lmod (replacing the older tcl versions)
